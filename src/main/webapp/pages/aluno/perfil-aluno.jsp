...
import="com.example.secretariaescolar.model.Aluno" %> <% Aluno aluno = (Aluno)
request.getAttribute("aluno"); String ctx = request.getContextPath(); String
nome = (aluno != null && aluno.getNome() != null) ? aluno.getNome() : ""; String
matricula = (aluno != null && aluno.getMatricula() != null) ?
aluno.getMatricula() : ""; String idTurma = (aluno != null) ?
String.valueOf(aluno.getId_turma()) : ""; String foto = (aluno != null) ?
aluno.getFoto() : null; boolean semFoto = (foto == null) || foto.isBlank() ||
"null".equalsIgnoreCase(foto.trim()) || "[null]".equalsIgnoreCase(foto.trim());
String fotoSrc = !semFoto ? (ctx + "/pages/uploads/" + foto) : (ctx +
...
<html lang="pt-br">
  <head>
    ...
    <link <link rel="icon" href="<%= ctx %>/assets/Group 551.ico" />
    ...
    <header class="topbar">
      <div class="topbar-inner">
        ...
        >
          <img
            class="topbar-logo"
            src="<%= request.getContextPath() %>/pages/assets/logo.png"
            alt="Logo Devant"
          />
        </a>

        <nav class="topbar-nav" aria-label="Navegação principal">
          <a class="topbar-link is-active" href="<%= ctx %>/aluno/perfil"
            >Perfil</a
          >
      ...
      <section class="card">
        <div class="card-header">
          ...
          <div class="pill-row">
            ...
            <a class="pill" href="<%= ctx %>/aluno/observacoes"
              >Observações <span class="pill-arrow">&gt;</span></a
            >
          </div>
        </div>
        ...
        <div class="profile">
          ...
          <div class="profile-info">
            ...
            <div class="info-block">
              ...
              <p class="info-value">
                <%= (aluno != null ? aluno.getNomeTurma() : "") %>
              </p>
            </div>
          </div>
        </div>

        <%-- Debug opcional (apague depois) --%> <% if (aluno == null) { %>
        <p style="margin-top: 16px; font-weight: 700; color: #283565">
          DEBUG: aluno veio NULL (o servlet não setou
