...
<%
  ...
  int total = (disciplinas != null) ? disciplinas.size() : 0;
...
<header class="topbar">
  <div class="topbar-inner">
    ...
    <nav class="topbar-nav" aria-label="Navegação principal">
      ...
      <a class="topbar-link is-active" href="<%= ctx %>/aluno/disciplinas">Disciplinas</a>
      ...
      <%
        ...
        if (disciplinas != null) {
          for (Disciplina d : disciplinas) {
            ...
            if (q != null && !q.isEmpty() && !nomeLower.contains(q)) {
              continue;
            }
