...
String disciplinaNome = (String) request.getAttribute("disciplinaNome"); Double
nota1 = (Double) request.getAttribute("nota1"); Double nota2 = (Double)
request.getAttribute("nota2"); Double media = (Double)
request.getAttribute("media"); Integer totalObs = (Integer)
request.getAttribute("totalObs"); Integer totalElogios = (Integer)
request.getAttribute("totalElogios"); Integer totalPdm = (Integer)
request.getAttribute("totalPdm"); List<Observacao>
  observacoes = (List<Observacao
    >) request.getAttribute("observacoes"); if (disciplinaNome == null)
    disciplinaNome = "Disciplina"; if (nota1 == null) nota1 = 0.0; if (nota2 ==
    null) nota2 = 0.0; if (media == null) media = 0.0; if (totalObs == null)
    totalObs = 0; if (totalElogios == null) totalElogios = 0; if (totalPdm ==
    null) totalPdm = 0; if (observacoes == null) observacoes = new
    ArrayList<>(); DateTimeFormatter fmt = DateTimeFormatter.ofPattern("dd/MM");
    String foto = (aluno != null) ? aluno.getFoto() : null; boolean semFoto =
    (foto == null) || foto.isBlank() || "null".equalsIgnoreCase(foto.trim()) ||
    "[null]".equalsIgnoreCase(foto.trim()); String fotoSrc = !semFoto ? (ctx +
    "/pages/uploads/" + foto) : (ctx + "/pages/aluno/foto_sem_foto.png"); //
    classes para borda dos cards (>=7 verde, <7 vermelho) String clsNota1 =
    (nota1 >= 7.0) ? "green" : "red"; String clsNota2 = (nota2 >= 7.0) ? "green"
    : "red"; String clsMedia = (media >= 7.0) ? "green" : "red"; %>
    ...
    <html lang="pt-br">
      <head>
        ...
        <style>
          ...
          .nota-card.green::before {
            background: #34ad38;
          }
          .nota-card.red::before {
            background: #cd3434;
          }
        ...
        <header class="topbar">
          <div class="topbar-inner">
            ...
            <nav class="topbar-nav" aria-label="Navegação principal">
              ...
              <a class="topbar-link" href="<%= ctx %>/aluno/disciplinas"
                >Disciplinas</a
              >
            ...
            <div class="card-header">
              ...
              <div class="cards-notas">
                <div class="nota-card <%= clsNota1 %>">
                  ...
                  <div class="nota-value">
                    <%= String.format(java.util.Locale.US, "%.2f", nota1) %>
                  </div>
                </div>
                ...
                <div class="nota-card <%= clsNota2 %>">
                  ...
                  <div class="nota-value">
                    <%= String.format(java.util.Locale.US, "%.2f", nota2) %>
                  </div>
                </div>
                ...
                <div class="nota-card <%= clsMedia %>">
                  ...
                  <div class="nota-value">
                    <%= String.format(java.util.Locale.US, "%.2f", media) %>
                  </div>
                </div>
              </div>
              ...
              <div class="obs-list" id="obsList">
                ...
                <div
                  ...
                  data-de="Sistema"
                  data-data=""
                  data-texto="Nenhuma observação nesta disciplina."
                  data-tipo="1"
                >
                  <div class="obs-top">
                ...
                <% } else { for (Observacao obs : observacoes) { int tipo =
                obs.getTipo(); // 1=boa, 2=ruim String cls = (tipo == 2) ?
                "tipo2" : ""; String msg = (obs.getMensagem() == null) ? "" :
                obs.getMensagem(); String dataStr = (obs.getData() != null) ?
                obs.getData().format(fmt) : ""; // ⚠️ Ajuste aqui se o seu
                getter tiver outro nome: // ex: obs.getNomeProfessor(),
                obs.getProfessor(), etc. String de = "Professor"; try { de =
                (String)
                obs.getClass().getMethod("getProfessorNome").invoke(obs); if (de
                == null || de.isBlank()) de = "Professor"; } catch (Exception
                ignore) { } // escapa aspas no atributo data-texto String
                msgAttr = msg.replace("\"","&quot;"); %>
                <div
                  class="obs-item <%= cls %>"
                  data-de="<%= de %>"
          ...
          >
            <div class="popup-head">
              <div class="popup-user">
                <img
                  class="popup-avatar"
                  src="<%= ctx %>/pages/aluno/foto_sem_foto.png"
                  alt="Foto"
                />
                <div>
