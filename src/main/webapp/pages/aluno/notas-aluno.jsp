...
import="com.example.secretariaescolar.model.Aluno" %> <%@ page
import="com.example.secretariaescolar.model.MediaDisciplina" %> <% String ctx =
request.getContextPath(); // ===== Dados vindos do servlet ===== Aluno aluno =
(Aluno) request.getAttribute("aluno"); // Geral (usado nos cards e fallback)
List<MediaDisciplina>
  medias = (List<MediaDisciplina
    >) request.getAttribute("medias"); // Novos: usados pelos botões do gráfico
    List<MediaDisciplina>
      mediasGeral = (List<MediaDisciplina
        >) request.getAttribute("mediasGeral"); List<MediaDisciplina>
          mediasS1 = (List<MediaDisciplina
            >) request.getAttribute("mediasS1"); List<MediaDisciplina>
              mediasS2 = (List<MediaDisciplina
                >) request.getAttribute("mediasS2"); Integer acima7 = (Integer)
                request.getAttribute("acima7"); Integer abaixo7 = (Integer)
                request.getAttribute("abaixo7"); Double mediaGeral = (Double)
                request.getAttribute("mediaGeral"); // ===== Proteção contra
                null ===== if (medias == null) medias = new ArrayList<>(); if
                (mediasGeral == null) mediasGeral = new ArrayList<>(); if
                (mediasS1 == null) mediasS1 = new ArrayList<>(); if (mediasS2 ==
                null) mediasS2 = new ArrayList<>(); if (acima7 == null) acima7 =
                0; if (abaixo7 == null) abaixo7 = 0; if (mediaGeral == null)
                mediaGeral = 0.0; String foto = (aluno != null) ?
                aluno.getFoto() : null; boolean semFoto = (foto == null) ||
                foto.isBlank() || "null".equalsIgnoreCase(foto.trim()) ||
                "[null]".equalsIgnoreCase(foto.trim()); String fotoSrc =
                !semFoto ? (ctx + "/pages/uploads/" + foto) : (ctx +
                ...
                <html lang="pt-br">
                  <head>
                    ...
                    <link
                      rel="stylesheet"
                      href="<%= ctx %>/pages/aluno/perfil.css"
                    />
                  ...
                  <body>
                    <header class="topbar">
                      <div class="topbar-inner">
                        ...
                        >
                          <a class="topbar-link" href="<%= ctx %>/aluno/perfil"
                            >Perfil</a
                          >
                          <a
                            class="topbar-link"
                    ...
                    <main class="page">
                      <section class="card">
                        <div class="card-header">
                          ...
                          <% MediaDisciplina cardDestaque = (MediaDisciplina)
                          request.getAttribute("cardDestaque"); MediaDisciplina
                          cardAtencao = (MediaDisciplina)
                          request.getAttribute("cardAtencao"); String
                          discMaiorEvolucao = (String)
                          request.getAttribute("discMaiorEvolucao"); Double
                          maiorEvolucao = (Double)
                          request.getAttribute("maiorEvolucao"); String
                          discMaiorRegressao = (String)
                          request.getAttribute("discMaiorRegressao"); Double
                          maiorRegressao = (Double)
                          request.getAttribute("maiorRegressao"); if
                          (maiorEvolucao == null) maiorEvolucao = 0.0; if
                          (maiorRegressao == null) maiorRegressao = 0.0; %>
                          ...
                          <div class="cards-row">
                            ...
                            <div class="disc-card">
                              <div class="disc-nome">
                                <%= (cardDestaque != null ?
                                cardDestaque.getDisciplina() : "—") %>
                              </div>
                              <div class="disc-sub">
                                Disciplina destaque <%= (cardDestaque != null ?
                                " • " + String.format(java.util.Locale.US,
                                "%.2f", cardDestaque.getMedia()) : "") %>
                              </div>
                            </div>
                            ...
                            <div class="disc-card atencao">
                              <div class="disc-nome">
                                <%= (cardAtencao != null ?
                                cardAtencao.getDisciplina() : "—") %>
                              </div>
                              <div class="disc-sub">
                                Nota em atenção <%= (cardAtencao != null ? " • "
                                + String.format(java.util.Locale.US, "%.2f",
                                cardAtencao.getMedia()) : "") %>
                              </div>
                            </div>
