...
<head>
    ...
    <link
            rel="icon"
            type="image/png"
            href="<%= request.getContextPath() %>/pages/assets/minimalismo-dark.png"
    />
...
<div class="container">
    ...
    <div class="card">
        ...
        text-align: left;">Bem-vindo à Devant!</h3>
        ...
        <div class="bloco-login">
            ...
            <form action="<%= request.getContextPath() %>/login" method="post">
                ...
                <input class="input" type="text" name="username"             style="font-family: 'Lato', sans-serif; font-weight: 300"
                        placeholder="usuário" required >
                <input class="input" type="password" name="password" placeholder="senha"             style="font-family: 'Lato', sans-serif; font-weight: 300"
                        required>
