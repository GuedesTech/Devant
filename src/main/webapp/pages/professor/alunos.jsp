...
List<Aluno>
  alunos = (List<Aluno
    >) request.getAttribute("alunos"); if (alunos == null) alunos = new
    ArrayList<>(); Map<Integer, Double>
      mediaPorAluno = (Map<Integer, Double
        >) request.getAttribute("mediaPorAluno"); if (mediaPorAluno == null)
        mediaPorAluno = new HashMap<>(); %>
        ...
        <html lang="pt-br">
          <head>
            ...
            <link
              rel="stylesheet"
              href="<%= ctx %>/pages/professor/alunos.css"
            />
          ...
          <body>
              ...
              <section class="card alunos-card">
                <div class="card-header">
                  ...
                  <div class="chip">
                    ...
                    /><span
                      >Total Alunos: <strong><%= totalAlunos %></strong></span
                    >
                  </div>
                </div>
                  ...
                  <div class="alunos-grid">
                    ...
                    <a class="aluno-card" href="<%= href %>">
                      <img
                              class="aluno-avatar"
                              src="<%= fotoSrc %>"
                              alt="Foto de <%= a.getNome() %>"
                      />

                      <div class="aluno-info">
                        <div class="aluno-nome"><%= a.getNome() %></div>
                        <div class="aluno-media">
                          Média: <%= String.format(java.util.Locale.US, "%.1f", media) %>
                        </div>
                      </div>
                    </a>
            ...
            <script>
              (function () {
                ...
                const indicador = nav
                  ? nav.querySelector(".nav-indicador")
                  : null;
