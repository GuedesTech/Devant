...
request.getContextPath(); Disciplina minha = (Disciplina)
request.getAttribute("minhaDisciplina"); if (minha == null) minha = new
Disciplina(); // evita null @SuppressWarnings("unchecked") List<Disciplina>
  outras = (List<Disciplina
    >) request.getAttribute("outrasDisciplinas"); if (outras == null) outras =
    new ArrayList<>(); Integer totalAlunos = (Integer)
    request.getAttribute("totalAlunos"); if (totalAlunos == null) totalAlunos =
    0; String q = request.getParameter("q"); if (q != null) q =
    q.trim().toLowerCase(); %>
    ...
    <html lang="pt-br">
      <head>
        ...
        />
        <link <link rel="stylesheet" href="<%= ctx %>/pages/aluno/perfil.css" />
        ...
        <header class="topbar">
          <div class="topbar-inner">
            ...
            <nav class="topbar-nav" aria-label="Navegação principal">
              <a class="topbar-link" href="<%= ctx %>/professor/turmas"
                >Turmas</a
              >
              <a
          ...
          <section class="card">
            <div class="card-header">
              ...
              >
                ...
                >
                  <img
                    src="<%= ctx %>/pages/professor/pessoas.png"
                    style="height: 17.5px; width: 24px"
                  />
                  <span style="font-size: 14px"
                    >Total Alunos: <%= totalAlunos %></span
                  >
                </div>
                ...
                <form
                  method="get"
                  action="<%= ctx %>/professor/disciplinas"
                  style="
                    display: flex;
                    align-items: center;
                    border: 2px solid var(--navy);
            ...
            <div style="margin-top: 22px">
              <div
                style="font-weight: 900; color: var(--navy); font-size: 18px"
              >
                Minha Disciplina
              </div>

              <% String nomeMinha = (minha.getNome() != null) ? minha.getNome()
              : ""; boolean mostrarMinha = true; if (q != null && !q.isEmpty()
              && !nomeMinha.toLowerCase().contains(q)) mostrarMinha = false; if
              (nomeMinha.isBlank()) { %>
              <p
                style="
                  margin-top: 10px;
              ...
              >
                ...
                >
                  ...
                  <span style="font-weight: 800; color: #294c56"
                    >Sua disciplina</span
                  >
                </div>
              </div>
            ...
            <div style="margin-top: 28px">
              ...
              <div
                ...
                "
              >
                <% boolean achou = false; for (Disciplina d : outras) { String
                nome = (d.getNome() != null) ? d.getNome() : ""; if (q != null
                && !q.isEmpty() && !nome.toLowerCase().contains(q)) continue;
                achou = true; %>
