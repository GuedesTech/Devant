...
public class ObservacaoDAO {
    public Observacao buscarPorIdDoProfessor(int idObservacao, int idProfessor, int idDisciplina) {
        String sql = """
                    SELECT
                        o.id_observacao,
                        o.mensagem,
    ...
    public boolean atualizar(Observacao o) {
        ...
        try (Connection conn = Conexao.conectar();
            ...
            stmt.setInt(2, o.getTipo());
            stmt.setInt(3, o.getId_observacao());
    ...
    public List<Observacao> listarPorAlunoEDisciplina(int idAluno, Integer idDisciplina) {
        ...
        String sql = """
                    ...
                    INNER JOIN usuario u ON u.id_user = p.id_user
                    WHERE o.id_aluno = ?
                      AND (? IS NULL OR o.id_disciplina = ?)
    ...
    public int contarTotalPorAlunoEDisciplina(int idAluno, Integer idDisciplina) {
        String sql = """
                    SELECT COUNT(*)
                    FROM observacao
                    WHERE id_aluno = ?
                      AND (? IS NULL OR id_disciplina = ?)
                """;
    ...
    public int contarPorAlunoETipoEDisciplina(int idAluno, int tipo, Integer idDisciplina) {
        String sql = """
                    SELECT COUNT(*)
                    FROM observacao
                    WHERE id_aluno = ?
